        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li><a href="especialidad.php">Listado de especialidades</a></li>
                 <li class="divider">></li>
                <li><a href="#" class="active">Actualizar especialidad</a></li>
            </ul>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off" onsubmit="return validacion()">
  <div class="containerss">
    <h1>Información de especialidad</h1>
...
<br>
   ...
   <button type="submit" name="upd_especialidades" class="registerbtn">Guardar</button>
...
<?php endforeach; ?>
    ...
    <?php include_once '../../backend/php/upd_especialidades.php' ?>
