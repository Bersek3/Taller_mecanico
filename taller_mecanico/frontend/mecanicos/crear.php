    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Crear perfil del del mecanico</a></li>
            </ul>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off" onsubmit="return validacion()">
  <div class="containerss">
    <h1>Crear perfil del del mecanico</h1>
    <?php include_once '../../backend/php/add_profileM.php' ?>
   <br>
    <hr>

    <label for="psw"><b>Nombre y apellidos del mecanico</b></label><span class="badge-warning">*</span>
    ...
    <label for="psw"><b>Correo electrónico del mecanico</b></label><span class="badge-warning">*</span>
    ...
    <label for="psw"><b>Contraseña del mecanico</b></label><span class="badge-warning">*</span>
    <input type="password"  name="pwdm"  required>

    <label for="psw"><b>Rol del mecanico</b></label><span class="badge-warning">*</span>
