    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="../mecanicos/mostrar.php">Listado de los médicos</a></li>
                <li class="divider">></li>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off" onsubmit="return validacion()">
  <div class="containerss">
    ...
    <?php include_once '../../backend/php/upd_pass_mecanico.php' ?>
   <br>
    <hr>
   ...
   <button type="submit" name="upd_pass_mecanico" class="registerbtn">Guardar</button>
  </div>
