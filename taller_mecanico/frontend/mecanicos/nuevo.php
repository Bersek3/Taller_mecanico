    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Nuevo mecanico</a></li>
            </ul>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off" onsubmit="return validacion()">
  <div class="containerss">
    <h1>Nuevo mecanico</h1>
    <?php include_once '../../backend/php/add_mecanico.php' ?>
  ...
  <strong>Importante!</strong> Es importante rellenar los campos con &nbsp;<span class="badge-warning">*</span>
    ...
    <input type="text" maxlength="13" placeholder="ejm: +569 45424321" name="telme" required>
    ...
    <button type="submit" name="add_mecanico" class="registerbtn">Guardar</button>
  </div>
