    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="../mecanicos/mostrar.php">Listado de mecanicos</a></li>
                <li class="divider">></li>
                <li><a href="#" class="active">Información del mecanico</a></li>
            </ul>
...
<form action="" enctype="multipart/form-data" method="POST"  autocomplete="off" onsubmit="return validacion()">
  <div class="containerss">
    <h1>Información del mecanico</h1>
   <br>
    <hr>

    <label for="email"><b>Cédula del mecanico</b></label><span class="badge-warning">*</span>
    ...
    <select required name="geme" readonly id="gep">
        <option value="<?php echo $d->clientesd; ?>"><?php echo $d->clientesd; ?></option>
    ...
    <label for="psw"><b>Fecha de nacimiento del mecanico</b></label><span class="badge-warning">*</span>
    <input type="date" value="<?php echo $d->nacd; ?>" name="cumme" readonly required>

    <label for="psw"><b>Correo  del mecanico</b></label><span class="badge-warning">*</span>
    <input type="text" value="<?php echo $d->corr; ?>" name="corr" readonly required>

     <label for="psw"><b>Usuario  del mecanico</b></label><span class="badge-warning">*</span>
