    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Listado de los mecanicos</a></li>
            </ul>
...
$sentencia = $connect->prepare("SELECT * FROM mecanicos ORDER BY idodc DESC;");
 $sentencia->execute();
$data =  array();
if($sentencia){
            ...
            <tbody>
                <?php foreach($data as $d):?>
                    <tr>
                        ...
                        <td data-title="mecanicos"><?php echo $d->nodoc ?>&nbsp;<?php echo $d->apdoc ?></td>
                        ...
                        <td>
                            <a title="Actualizar" href="../mecanicos/editar.php?id=<?php echo $d->idodc ?>" class="fa fa-pencil tooltip"></a>
                            <a title="Información" href="../mecanicos/info.php?id=<?php echo $d->idodc ?>" class="fa fa-info"></a>
...
<button name='delete_patients' style="cursor: pointer;" class="fa fa-trash"></button>
                            ...
                            <?php 
                                if ($d->rol == '3') {
                                    // code...
                echo '<a title="Cambiar contraseña"  href="../mecanicos/password.php?id='.$d->idodc.'" class="fa fa-key"></a>';
                                }else {
                                    echo '<a title="Crear perfil" href="../mecanicos/crear.php?id='.$d->idodc.'" class="fa fa-user-plus"></a>';
                                }
    ...
    <?php include_once '../../backend/php/delete_mecanico.php' ?>
    <!-- NAVBAR -->
