    ...
    function Header()
{
    ...
    $this->setY(12);
    $this->setX(10);
    $this->Image('../../backend/img/logo.png',25,5,33);
    $this->SetFont('times', 'B', 13);
    $this->Text(75, 15, utf8_decode('Servicio Automotriz'));
    $this->Text(75, 20, utf8_decode('Mecanico: '.$_SESSION['name'].''));
    $this->Text(75,25, utf8_decode('Tel: +569 87363738'));
    $this->Text(75,30, utf8_decode('Servicio_automotriz@gmail.com'));
    
    
    $this->Image('../../backend/img/logo.png',160,5,33);
...
//información de # de factura
    ...
    $this->Text(10,48, utf8_decode('DATOS DEL CLIENTE'));
    $this->Ln(50);


    $this->SetFont('Arial','B',10);    
    $this->Text(10,75, utf8_decode('ESPECIALIDAD'));
    $this->Ln(50);



     // Agregamos los Consulta del cliente

    $this->SetFont('Arial','B',10);    
    $this->Text(10,199, utf8_decode('REPARACION'));
    $this->Ln(50);
...
function Footer()
{
     $this->SetFont('helvetica', 'B', 8);
        ...
        $this->Cell(0,5,utf8_decode("Taller Automotriz © Todos los derechos reservados."),0,0,"C");
...
$pdf->setY(50);$pdf->setX(135);
    ...
    $id = $_GET['id'];
    $stmt = $connect->prepare("SELECT * FROM clientes WHERE idpa= '$id'");
