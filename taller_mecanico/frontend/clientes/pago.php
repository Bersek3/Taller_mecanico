    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Historial de los pagos de clientes</a></li>
            </ul>
           <br>
...
$id = $_GET['id'];
$sentencia = $connect->prepare("SELECT citas.id, citas.title, clientes.idpa, clientes.numhs,clientes.nompa, clientes.apepa, doctor.idodc, doctor.ceddoc, doctor.nodoc,doctor.nomesp, doctor.apdoc, especialidades.idlab, especialidades.nomlab, citas.start, citas.end, citas.color, citas.state,citas.chec,citas.monto,citas.fere FROM citas INNER JOIN clientes ON citas.idpa = clientes.idpa INNER JOIN doctor ON citas.idodc = doctor.idodc INNER JOIN especialidades ON citas.idlab = especialidades.idlab  WHERE clientes.idpa= '$id';");
 $sentencia->execute();
$data =  array();
if($sentencia){
  while($r = $sentencia->fetchObject()){
