    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Documentos de los clientes</a></li>
            </ul>
                ...
                <?php foreach($data as $d):?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a title="Documentos" href="../clientes/documentos_nuevo.php?id=<?php echo $d->idpa ?>" class="fa fa-file-text-o"></a>
