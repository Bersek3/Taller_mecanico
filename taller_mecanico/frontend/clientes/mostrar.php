    ...
    <section id="content">
        ...
        <main>
            ...
            <ul class="breadcrumbs">
                ...
                <li class="divider">></li>
                <li><a href="#" class="active">Listado de clientes</a></li>
            </ul>
            ...
            <tbody>
                <?php foreach($data as $d):?>
                    <tr>
                        ...
                        <td>
                            <a title="Actualizar" href="../clientes/editar.php?id=<?php echo $d->idpa ?>" class="fa fa-pencil tooltip"></a>
                            <a title="Información" href="../clientes/info.php?id=<?php echo $d->idpa ?>" class="fa fa-info"></a>
                            <a title="Historial mecanico" href="../clientes/historia.php?id=<?php echo $d->idpa ?>" class="fa fa-stethoscope"></a>

                            
                            <form  onsubmit="return confirm('Realmente desea eliminar el registro?');" method='POST' action='<?php $_SERVER['PHP_SELF'] ?>'>
<input type='hidden' name='idpa' value="<?php echo  $d->idpa; ?>">

<button name='delete_clientes' style="cursor: pointer;" class="fa fa-trash"></button>
</form>

                            <?php 
                                if ($d->rol == '2') {
                                    // code...
                echo '<a title="Cambiar contraseña"  href="../clientes/password.php?id='.$d->idpa.'" class="fa fa-key"></a>';
                                }else {
                                    echo '<a title="Crear perfil" href="../clientes/crear.php?id='.$d->idpa.'" class="fa fa-user-plus"></a>';
                                }
    ...
    <?php include_once '../../backend/php/delete_clientes.php' ?>
    <!-- NAVBAR -->
