...
CREATE TABLE `doctor` (
  ...
  `generod` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `doctor` (`idodc`, `ceddoc`, `nodoc`, `apdoc`, `nomesp`, `direcd`, `generod`, `phd`, `nacd`, `corr`, `username`, `password`, `rol`, `state`, `fere`) VALUES
...
INSERT INTO `citas` (`id`, `title`, `idpa`, `idodc`, `idlab`, `color`, `start`, `end`, `state`, `monto`, `chec`, `fere`) VALUES
...
CREATE TABLE `nurse` (
  ...
  `generonur` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `state` char(1) COLLATE utf8_unicode_ci NOT NULL,
  `fere` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `nurse` (`idnur`, `numide`, `nomnur`, `apenur`, `nacinur`, `generonur`, `state`, `fere`) VALUES
...
INSERT INTO `genero` (`idpa`, `numhs`, `nompa`, `apepa`, `direc`, `genero`, `grup`, `phon`, `cump`, `corr`, `username`, `password`, `rol`, `state`, `fere`) VALUES
...
--
ALTER TABLE `citas`
  ADD CONSTRAINT `citas_ibfk_1` FOREIGN KEY (`idpa`) REFERENCES `genero` (`idpa`),
  ADD CONSTRAINT `citas_ibfk_2` FOREIGN KEY (`idodc`) REFERENCES `doctor` (`idodc`),
