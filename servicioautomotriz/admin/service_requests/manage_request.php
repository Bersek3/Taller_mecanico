...
<div class="container-fluid">
    ...
    <div class="col-12">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="category_id" class="control-label">Tipo de Vehiculo</label>
                ...
                <div class="form-group">
                    <label for="owner_name" class="control-label">Nombre Completo</label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="vehicle_name" class="control-label">Marca del Vehiculo</label>
                ...
                <div class="form-group">
                    <label for="vehicle_registration_number" class="control-label">Patente</label>
                ...
                <div class="form-group">
                    <label for="vehicle_model" class="control-label">Modelo del Vehiculo</label>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group " id="mechanic-holder">
                    <label for="mechanic_id" class="control-label">Asignado por:</label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="status" id="status" class="custom-select custom-select-sm rounded-0" required>
                        ...
                        <option value="3" <?php echo isset($status) && $status == 3 ? "selected" : '' ?>>Realizado</option>
        ...
        <div class="w-100 d-flex justify-content-end mx-2">
            <div class="col-auto">
                <button class="btn btn-primary btn-sm rounded-0">Guardar orden</button>
