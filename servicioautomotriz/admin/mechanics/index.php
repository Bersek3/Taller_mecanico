...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Lista de mecanicos</h3>
		<div class="card-tools">
			<a href="?page=mechanics/manage_mechanic" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> Ingresar mecanico</a>
		</div>
	</div>
	<div class="card-body">
